    ...
    >
      ...
      <nav class="mt-10">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 20 20" fill="currentColor">
          ...
          <span class="mx-4">Oders</span>
        </router-link>

        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[$route.name === 'ActivitiesForm' ? activeClass : inactiveClass]"
          to="/activitiesForm"
        >
          <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
            <path
        ...
        >
          ...
          <span class="mx-4">Records</span>
        </router-link>
        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[$route.name === 'Sales' ? activeClass : inactiveClass]"
          to="/sales"
        >
          <svg
            class="w-5 h-5"
